...
# FINAL: No care about the pep of internal node, make sure tha the pep of all cleaners are not the same with all non-cleaners
# revise Detect_Nons.pl, here upload as "Detect_Nons_Final.pl"
